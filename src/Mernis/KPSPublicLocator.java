...
public class KPSPublicLocator extends org.apache.axis.client.Service implements Mernis.KPSPublic {
    ...
    public Mernis.KPSPublicSoap_PortType getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Mernis.KPSPublicSoap_BindingStub _stub = new Mernis.KPSPublicSoap_BindingStub(portAddress, this);
    ...
    public Mernis.KPSPublicSoap_PortType getKPSPublicSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Mernis.KPSPublicSoap12Stub _stub = new Mernis.KPSPublicSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Mernis.KPSPublicSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Mernis.KPSPublicSoap_BindingStub _stub = new Mernis.KPSPublicSoap_BindingStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
            if (Mernis.KPSPublicSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Mernis.KPSPublicSoap12Stub _stub = new Mernis.KPSPublicSoap12Stub(new java.net.URL(KPSPublicSoap12_address), this);
                _stub.setPortName(getKPSPublicSoap12WSDDServiceName());
                return _stub;
            }
        }
